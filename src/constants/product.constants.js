...
export const PRODUCT_CATEGORY_GET_REQUEST = "PRODUCT_GET_REQUEST";
export const PRODUCT_CATEGORY_GET_SUCCESS = "PRODUCT_GET_SUCCESS";
export const PRODUCT_CATEGORY_GET_FAIL = "PRODUCT_GET_FAIL";
...
export const COLOR = ["BLACK", "GREY", "BROWN", "RED", "BLUE"];
export const CATEGORY = ["여성용", "남성용", "선글라스"];
